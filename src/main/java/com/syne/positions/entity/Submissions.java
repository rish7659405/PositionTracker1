...
public class Submissions {
	...
	private String selectOrDropoutDate;
	private String l1panelist;
	private String l1panelist2;
	...
	public String getSubmissionValidity() {
		return submissionValidity;
	}
	public void setSubmissionValidity(String submissionValidity) {
	...
	public String getSelectOrDropoutDate() {
		return selectOrDropoutDate;
	}
	public void setSelectOrDropoutDate(String selectOrDropoutDate) {
		this.selectOrDropoutDate = selectOrDropoutDate;
	}
	...
	public String getL1panelist2() {
		return l1panelist2;
	}
	public void setL1panelist2(String l1panelist2) {
		this.l1panelist2 = l1panelist2;
	}
